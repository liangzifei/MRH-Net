...
The file list under Train_Data is the following:
...
The overlapped FA and Nissl is the following (high quality file can be downloaded from https://osf.io/5xr43/):
